import { hostname, imageBasePath, port, jsonDataFileSuffix } from './environment.ts';
...
const buildResponse = (errorId: ErrorId) => new Response(config.statusCodes[errorId].message, {
...
const handler = async (req: Request) => {
  ...
  const filePath = `${directoryPath}/${requestPath[1]}_${requestPath[2]}-${jsonDataFileSuffix}`
